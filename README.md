...
de imágenes y teclas a almacenar en inputs.json y las carpetas de imágenes Accesoimgs. En caso de
...
de interfaz, se pueden crear nuevas carpetas Accesoimgs+número en las que almacenar imágenes 
alternativas con el mismo nombre que la original de Accesoimgs.

Para definir una ruta de imágenes en las que hacer clic/teclas que pulsar cada cierto tiempo se han 
de añadir en las carpetas Accesoimgs y definir el inputs.json de la siguiente manera, teniendo
